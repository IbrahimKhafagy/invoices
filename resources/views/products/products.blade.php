                            ...
                            <div class="card-header pb-0">
                                ...
                                <div class="pr-1 mb-3 mb-xl-0">
                                    <div class="col-sm-6 col-md-3">
                                        <button type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#exampleModal"  class="fas fa-plus"></i>&nbsp;اضافة منتج</button>
                                    </div>
                                </div>
                            </div>
...
<script>
    $('#edit_Product').on('show.bs.modal', function(event) {
        ...
        var modal = $(this)
        modal.find('.modal-body #roduct_name').val(Product_name);
